...
func (p *GraylogProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewOutputTypesDataSource,
		NewLookupAdapterTypesDataSource,
		NewLookupCacheTypesDataSource,
		NewIndexSetStrategyTypesDataSource,
		NewEventNotificationTypesDataSource,
		NewEventEntityTypesDataSource,
		NewStreamDataSource,
